...
Now we have the data in a format ready for visualizing and the regression In addition to that, we already showed how to get the coordinates of Copenhagen's metro stations, which will be used in the calculation of the distance to the apartments in the regression section. The full code can be found in the source code. 
